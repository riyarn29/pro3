			...
			<div class="row pt-3">
				...
				<div class="col-md-4 mb-4">
						...
						<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										class="form-control" placeholder="Enter date" maxlength="10"
								...
								<span class="pl-sm-5"><b>Mode</b> <span style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
					...
					: DataUtility.getStringData(dto.getCost())%>">
								...
								<font color="red" class="pl-sm-5" id="costError">
									<%=ServletUtility.getErrorMessage("cost", request)%></font></br>
