		...
		<form class="pb-5" action="<%=ORSView.ABC_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<font color="red" class="pl-sm-5" id="phoneNumberError"></font>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">Phone Number</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getPhoneNumber()%></td>




							<td class="text"><a
								href="AbcCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
