...
public class TransportationModelHibImp implements TransportationModelInt {
	...
	public long add(TransportationDTO dto) throws ApplicationException, DuplicateRecordException {
		 ...
		 TransportationDTO existDto = null;
			...
			try {
				...
				throw new ApplicationException("Exception in Tranportation Add " + e.getMessage());
			} finally {
				session.close();
			}
	...
	public void delete(TransportationDTO dto) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception in Tranportation Delete" + e.getMessage());
		} finally {
			session.close();
		}
	...
	public void update(TransportationDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			throw new ApplicationException("Exception in Tranportation update" + e.getMessage());
		} finally {
			session.close();
		}
	...
	public TransportationDTO findByLogin(String login) throws ApplicationException {
		...
		try {
			...
			e.printStackTrace();
			throw new ApplicationException("Exception in getting Tranportation by Login " + e.getMessage());
			...
			if (dto != null) {
				...
				if (dto.getId() != null && dto.getId() > 0) {
				  ...
				  if (dto.getCost() > 0) {
					...
					throw new ApplicationException("Exception in Tranportation search");
				} finally {
					session.close();
				}
